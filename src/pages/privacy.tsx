...
function Privacy(): ReactElement {
  return (
    <>
      ...
      <Container>
        <div
          id="thesustainablelist_policy"
          className="thesustainablelist_fluid_policy thesustainablelist_embed_policy "
        >
          <div id="wbars_all">
            <div className="tsl_container tsl_base_container">
              <div id="wbars">
                <div className="tsl_content legal_pp">
                  ...
                  <div className="one_line_col">
                    ...
                    <p>
                      ...
                      Website is mandatory and failure to provide this Data may
                      make it impossible for this Website to provide its
                      services. In cases where this Website specifically states
                      that some Data is not mandatory, Users are free not to
                      communicate this Data without consequences to the
                      ...
                      Website or by the owners of third-party services used by
                      this Website serves the purpose of providing the Service
                    ...
                    <p>
                      ...
                      obtained, published or shared through this Website and
                  ...
                  <div className="one_line_col">
                    ...
                    <p>
                      ...
                      with the operation of this Website (administration, sales,
                      marketing, legal, system administration) or external
                      ...
                      Processors by the Owner. The updated list of these parties
                    ...
                    <p>
                      ...
                      involve transferring the User&apos;s Data to a country
                    ...
                    <p>
                      ...
                      Data transfers to a country outside the European Union or
                      to any international organization governed by public
                    ...
                    <p>
                      ...
                      Data for a longer period whenever required to do so for
                      the performance of a legal obligation or upon order of an
                      authority.
                      <br />
                      <br />
                  ...
                  <div className="one_line_col">
                    ...
                    <p>
                      ...
                      obligations, respond to enforcement requests, protect its
                      rights and interests (or those of its Users or third
                      parties), detect any malicious or fraudulent activity, as
                      well as the following: Analytics, Managing contacts and
                      sending messages, Contacting the User, Tag Management and
                    ...
                    <ul className="for_boxes">
                      <li>
                        <div className="box_primary box_10 expand">
                          <h3 className="expand-click w_icon_24 policyicon_purpose_6896735">
                            Contacting the User
                          </h3>
                          <div className="expand-content">
                            ...
                            <div className="wrap">
                              <p>
                                ...
                                receive email messages containing information of
                                commercial or promotional nature concerning this
                                Website. Your email address might also be added
                                to this list as a result of signing up to this
                      ...
                      <li>
                        <div className="box_primary box_10 expand">
                          <h3 className="expand-click w_icon_24 policyicon_purpose_8525604">
                            Hosting and backend infrastructure
                          </h3>
                          <div className="expand-content">
                            <p>
                              This type of service has the purpose of hosting
                              Data and files that enable this Website to run and
                              be distributed as well as to provide a ready-made
                              infrastructure to run specific features or parts
                              of this Website.
                            </p>
                            <p>
                            ...
                            <h4>Contentful (Contentful GmbH)</h4>
                            <div className="wrap">
                              <p>
                                Contentful is a hosting and backend service
                                provided by Contentful GmbH.
                              </p>
                            </div>
                            <p>
                            ...
                            <p>
                              ...
                              <a
                                href="https://www.contentful.com/privacy/"
                                target="_blank"
                  ...
                  <div className="one_line_col">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        to learn if Data is being processed by the Owner, obtain
                      ...
                      <li>
                        ...
                        have the right to verify the accuracy of their Data and
                      ...
                      <li>
                        ...
                        User&apos;s consent, on a contract which the User is
                    ...
                    <p>
                      ...
                      the exercise of an official authority vested in the Owner
                      or for the purposes of the legitimate interests pursued by
                      the Owner, Users may object to such processing by
                      providing a ground related to their particular situation
                      to justify the objection.
                    </p>
                    <p>
                      Users must know that, however, should their Personal Data
                      be processed for direct marketing purposes, they can
                      object to that processing at any time without providing
                      any justification. To learn, whether the Owner is
                  ...
                  <div className="one_line_col">
                    ...
                    <p>
                      ...
                      purposes by the Owner in Court or in the stages leading to
                    ...
                    <p>
                      ...
                      policy, this Website may provide the User with additional
                      and contextual information concerning particular Services
                      or the collection and processing of Personal Data upon
                      request.
                    </p>
                    ...
                    <p>
                      ...
                      Please see the contact information at the beginning of
                      this document.
                    </p>
                    ...
                    <p>
                      ...
                      page and possibly within this Website and/or - as far as
                      technically and legally feasible - sending a notice to
                      Users via any contact information available to the Owner.
                      It is strongly recommended to check this page often,
                      referring to the date of the last modification listed at
                      the bottom. <br />
                      <br />
                      Should the changes affect processing activities performed
                      on the basis of the User’s consent, the Owner shall
                  ...
                  <div className="one_line_col">
                    ...
                    <p>
                      ...
                      the information contained in the rest of the privacy
                      policy and is provided by the business running this
                      Website and, if the case may be, its parent, subsidiaries
                      and affiliates (for the purposes of this section referred
                    ...
                    <p>
                      ...
                      (Users are referred to below, simply as “you”, “your”,
                      “yours”), and, for such consumers, these provisions
                      supersede any other possibly divergent or conflicting
                    ...
                    <p>
                      ...
                      information that we&apos;ve collected, disclosed or sold
                    ...
                    <p>
                      ...
                      information about you: identifiers and internet
                      information.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      Website. You also provide personal information indirectly
                      when you navigate this Website, as personal information
                      about you is automatically observed and collected.
                      Finally, we may collect your personal information from
                      third parties that work with us in connection with the
                      Service or with the functioning of this Website and
                      features thereof.
                    </p>
                    <h4>
                      How we use the information we collect: sharing and
                      disclosing of your personal information with third parties
                      for a business purpose
                    </h4>
                    <p>
                      We may disclose the personal information we collect about
                      you to a third party for business purposes. In this case,
                      we enter a written agreement with such third party that
                      requires the recipient to both keep the personal
                      information confidential and not use it for any purpose(s)
                      other than those necessary for the performance of the
                      agreement.
                    </p>
                    <p>
                      We may also disclose your personal information to third
                      parties when you explicitly ask or authorize us to do so,
                    ...
                    <p>
                      ...
                      in writing, or by electronic means, a consumer&apos;s
                    ...
                    <p>
                      ...
                      an application runs ads, or makes statistical analyses on
                      the traffic or views, or simply because it uses tools such
                    ...
                    <p>
                      ...
                      information. This means that whenever you request us to
                      stop selling your data, we will abide by your request.
                      <br />
                    ...
                    <p>
                      If you’d like to know more, or exercise your right to opt
                      out in regard to all the sales carried out by this
                      Website, both online and offline, you can contact us for
                      further information using the contact details provided in
                      this document.
                    </p>
                    <h4>
                    ...
                    <p>
                      ...
                      operational functioning of this Website and features
                      ...
                      which it was collected, and strictly within the limits of
                    ...
                    <p>
                      ...
                      within the section “Detailed information on the processing
                      of Personal Data” within this document), as well as for
                      complying with the law and defending our rights before the
                      competent authorities where our rights and interests are
                    ...
                    <ul>
                      <li>
                        ...
                        that we collect about you, the purposes for which we use
                        your information and with whom such information is
                        shared;
                      </li>
                      <li>
                    ...
                    <p>
                      ...
                      enclosed will be &quot;portable&quot;, i.e. delivered in
                      an easily usable format to enable you to transmit the
                      information to another entity without hindrance – provided
                    ...
                    <p>
                      ...
                      the law (such as, including but not limited to, where the
                      information is used to identify and repair errors on this
                      Website, to detect security incidents and protect against
                    ...
                    <p>
                      ...
                      your verifiable request to us by contacting us via the
                      details provided in this document.
                    </p>
                    <p>
                      For us to respond to your request, it’s necessary that we
                      know who you are. Therefore, you can only exercise the
                      above rights by making a verifiable request which must:
                    </p>
                    <ul>
                      <li>
                    ...
                    <p>
                      If you cannot personally submit a verifiable request, you
                      can authorize a person registered with the California
                    ...
                    <p>
                      ...
                      10 days and provide information about how we will process
                      your request.
                    </p>
                    <p>
                      We will respond to your request within 45 days of its
                      receipt. Should we need more time, we will explain to you
                      the reasons why, and how much more time we need. In this
                      regard, please note that we may take up to 90 days to
                    ...
                    <p>
                      ...
                      reasonable fee, or refuse to act on the request. In either
                      case, we will communicate our choices and explain the
                      reasons behind it.
                    </p>
                  </div>
                  <div className="one_line_col">
                    <div className="box_primary box_10 definitions expand">
                      ...
                      <div className="expand-content">
                        ...
                        <p>
                          ...
                          numerical code indicating the status of the
                          server&apos;s answer (successful outcome, error,
                          etc.), the country of origin, the features of the
                          browser and the operating system utilized by the User,
                          the various time details per visit (e.g., the time
                          spent on each page within the Application) and the
                          details about the path followed within the Application
                          with special reference to the sequence of pages
                          visited, and other parameters about the device
                  ...
                  <div className="tsl_footer">
                    <p>Latest update: July 17, 2021</p>
                  </div>
                </div>
              </div>
            </div>
