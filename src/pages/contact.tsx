      ...
      <Container minHeight="66vh">
        <Section>
          ...
          <Paragraph marginBottom={minorScale(4)}>
            We&apos;d love to hear from you and know your thoughts! If you have
            any feedback, ideas or criticism, please don&apos;t hesitate to get
            in touch with us. You can also follow us on social media to get the
            latest news.
          </Paragraph>
          <Paragraph marginBottom={minorScale(4)}>
            <Link
          ...
          <Paragraph marginBottom={minorScale(4)}>
            If you want to help us move this project forward, feel free to join
            the discussion on Product Hunt:
          </Paragraph>
          <Paragraph marginBottom={minorScale(4)}>
            <a
              ...
              <>
                {status && status.success && (
                  <Alert
                    ...
                    intent="success"
                    title={"Your form has been submitted successfully. Thanks!"}
                  />
                )}
