...
export const ContentTeam = () => (
  <Section noPadding>
    ...
    <TeamMember
      ...
      name="Noah"
      role="Visionary"
      description="Noah is our main source of inspiration. Though he doesn't actively contribute to the project (yet), he has reinforced our thinking about the future of his generation and why we want to contribute to become more sustainable as a society."
    />
    <TeamMember
