...
export const ContentAbout = () => (
  <>
    <Pane
      width="50%"
      paddingRight="10%"
      className={`content-about ${className}`}
    >
      <Heading
        size={700}
      ...
      <Pane color={colors.secondary} marginBottom={majorScale(4)}>
        <Paragraph fontWeight={700} marginBottom={minorScale(4)}>
          ...
          all over the world. These brands produce good-looking, quality
          products while doing less harm to the planet.
        </Paragraph>
        <Paragraph marginBottom={minorScale(4)}>
          We choose brands that work with recycled materials, work towards a
          more responsible supply chain and contribute to a more sustainable,
          greener future.
        </Paragraph>
        <Paragraph marginBottom={minorScale(7)}>
          Many of them have been recognised for their work towards
          sustainability and certificed by associations like{' '}
        ...
        <Paragraph>
          ...
          to make it easier for people to make the right choice the next time
          they want to go shopping. Keep in mind though that the best choice as
          a responsible consumer is to not buy at all .
        </Paragraph>
        <Paragraph></Paragraph>
      </Pane>
    </Pane>
