...
function createClient(params) {
  ...
  const config = _objectSpread({}, defaultConfig, {}, params);
...
function createContentfulApi({
  ...
  function getSpace() {
    switchToSpace(http);
    return http.get('').then(response => wrapSpace(response.data), errorHandler);
  }
  /**
   * Gets a Content Type
   * @memberof ContentfulClientAPI
  ...
  function getContentType(id) {
    ...
    return http.get('content_types/' + id).then(response => wrapContentType(response.data), errorHandler);
  }
  /**
  ...
  function getEntries(query = {}) {
    ...
    return http.get('entries', Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
      query: query
    })).then(response => wrapEntryCollection(response.data, {
      resolveLinks,
      removeUnresolved
    }), errorHandler);
  }
...
function wrapEntryCollection(data, {
  ...
  const wrappedData = Object(_mixins_stringify_safe__WEBPACK_IMPORTED_MODULE_2__["default"])(Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data)));
...
function pagedSync(http, query, options = {}) {
  ...
  return getSyncPage(http, [], query, syncOptions).then(response => {
